<?php
    //By Nicholas Comeaux
    //connection to database and defining variables
    ...
    $query = "INSERT INTO reservations (ResName,ResSize,ResDate,ResTime) 
    VALUES ('$Name', '$Size', '$Date', '$Time')";
    $query_run = mysqli_query($con, $query);
?>
<!-- Copy paste of reervation page -->
<!DOCTYPE html>
<html>
    <head>
        <!-- By: Nicholas Comeaux-->
    ...
    <body>
        ...
        <div>
            ...
            <!-- Display Weather Reservation was Made -->
            <p id="msg">
                <?php 
                if($con->query($query) == TRUE)
                {
                    echo "Reservation made for $Name on $Date at $Time";
                }
                else{
        ...
        <div>
            ...
            <form id="searchRes" method="GET">
                ...
                <input type="date" name="searchDate" value="<?php if(isset($_GET['searchDate'])){echo $_GET['searchDate'];} else{echo "2023/05/02";}?>">
